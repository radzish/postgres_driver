...
class MethodOverrideTemplate {
  ...
  MethodOverrideTemplate.fromElement(ExecutableElement method) {
    ...
    this
      ...
      ..returnTypeArgsRaw = findReturnTypeArgumentTypeNames(method).join(",")
      ..returnTypeArgs = SurroundedCommaList('<', '>', findReturnTypeArgumentTypeNames(method));
  }

  String name;
  String returnType;
  String returnTypeArgsRaw;
