...
class TransactionalClassCodegenErrors implements CodegenError {
  TransactionalClassCodegenErrors(this.name) {
    _errorCategories = [
      nonAbstractTransactionalDeclarations,
      nonPrivateTransactionalDeclarations,
      staticMethods,
  ...
  final NonAbstractTransactionalDeclarations nonAbstractTransactionalDeclarations =
      NonAbstractTransactionalDeclarations();
  final NonPrivateTransactionalDeclarations nonPrivateTransactionalDeclarations = NonPrivateTransactionalDeclarations();
...
abstract class _InvalidTransactionalDeclarations implements CodegenError {
...
class NonPrivateTransactionalDeclarations extends _InvalidTransactionalDeclarations {
  @override
  String get message => 'Transactional classes must be marked private. Affected classes: $_classNames.';
}

class NonAbstractTransactionalDeclarations extends _InvalidTransactionalDeclarations {
  @override
  String get message => 'Transactional classes must be abstract. Affected classes: $_classNames.';
}
